...
import com.bootcamp.enums.FromStatus;
import com.bootcamp.enums.Payment;
import com.bootcamp.enums.ToStatus;
     ...
     public ResponseEntity<String> directOrder(Long productVariationId, int quantity) {
         ...
         if (quantity == 0) {
             ...
             if (p.isPresent()) {
                 ...
                 if (productVariation.getIsActive() && !product.getIsDeleted()) {
                     if (productVariation.getQuantityAvailable() == 0) {
    ...
    public ResponseEntity<String> returnOrder(long orderProductId){
        ...
        if (o.isPresent()){
            ...
            if(order.getCustomer().getId()==customer.getId()) {
                ...
                if (p.getIsReturnable() && !(p.getIsReturnable() == null)) {
